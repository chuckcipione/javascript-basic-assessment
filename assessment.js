...
var thirdHero = JSON.parse(JSON.stringify('batman'));
...
var doubleTheFun = function(double){
	if(isNaN(double)){
...
var getValueOfProperty = function(obj, objname){
	return obj[objname];
}
...
var outside = function(temp, humid, clouds){
	if(temp > 80 && humid > 40){
